...
# Run `pod lib lint jumpcoinlib_flutter.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'jumpcoinlib_flutter'
...
The secp256k1 library bundled into the flutter plugin via cocoapods.
                       DESC
  s.homepage         = 'http://kamania.com'
  s.license          = { :file => '../LICENSE' }
  s.author           = 'Kamanias Developers'
